...
namespace kinectExpirement
{
    ...
    public class KinectSensorClass
    {
        public KinectSensor sensor;
        public IList<Body> bodies;
        public bool first = true, checkVelocity = false;
        public List<double> lists = new List<double>();
        public List<double> velocityAngle = new List<double>();
    ...
    {
        private  float offset, temp_value;
        ...
        public  List<double> input_values = new List<double>();
        /// <summary> The list of doubles that will hold all of the filtered values read in by the encoder. </summary>
        public  List<double> input_filtered_values = new List<double>();
        ...
        public EncoderSensorClass(KinectForm f)
        {
            arduino = new ArduinoControl(f);
            form = f;
        }
    ...
    public class FileProcessing
    {
        ...
        public FileProcessing(String name, String type, KinectForm f)
        {
